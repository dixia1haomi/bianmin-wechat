...
Component({
  ...
  methods: {
    ...
    go_map_() {
      let map = {
        address: this.data.Res.kuozhan.cheliang_chushou_dizhi,
        longitude: this.data.Res.kuozhan.cheliang_chushou_longitude,
        latitude: this.data.Res.kuozhan.cheliang_chushou_latitude
      }
