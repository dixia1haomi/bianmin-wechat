...
Component({
  ...
  methods: {
    ...
    go_map_() {
      let map = {
        address: this.data.Res.kuozhan.wupin_chushou_weizhi,
        longitude: this.data.Res.kuozhan.wupin_chushou_longitude,
        latitude: this.data.Res.kuozhan.wupin_chushou_latitude
      }
