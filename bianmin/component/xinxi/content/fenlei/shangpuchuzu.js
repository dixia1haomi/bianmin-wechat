...
Component({
  ...
  methods: {
    ...
    go_map_() {
      let map = {
        address: this.data.Res.kuozhan.shangpu_chuzu_weizhi,
        longitude: this.data.Res.kuozhan.shangpu_chuzu_longitude,
        latitude: this.data.Res.kuozhan.shangpu_chuzu_latitude
      }
