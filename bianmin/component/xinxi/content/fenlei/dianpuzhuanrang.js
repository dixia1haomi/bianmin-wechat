...
Component({
  ...
  methods: {
    ...
    go_map_() {
      let map = {
        address: this.data.Res.kuozhan.dianpu_zhuanrang_weizhi,
        longitude: this.data.Res.kuozhan.dianpu_zhuanrang_longitude,
        latitude: this.data.Res.kuozhan.dianpu_zhuanrang_latitude
      }
